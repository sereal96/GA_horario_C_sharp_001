...
namespace GA_horario_C_sharp_001
{
    public class Startup
    {
        ...
        {
            string ConexionPostgress = Configuration.GetValue<string>("ConnectionStrings:myconn");
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                //i1.CrearGenomaS(5, 6, 2, 20, 5, 20);
                //string aux = i1.PrintIndividuoString();

                Poblacion poblacion = new Poblacion();
                int poblacionTamano = 100;// 100;

                Obtener_datos_bd obtenerDatosBd = new Obtener_datos_bd(Configuration);
                ...
                {
                    await context.Response.WriteAsync(aux);
                });
            });
        }
    }
